 ...
 */
exports.sendText = async function (openid, text, kfaccount) {
 ...
 */
exports.sendImage = async function (openid, mediaId, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"image",
 ...
 */
exports.sendCard = async function (openid, cardid, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"wxcard",
 ...
 */
exports.sendVoice = async function (openid, mediaId, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"voice",
 ...
 */
exports.sendVideo = async function (openid, mediaId, thumbMediaId, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"video",
 ...
 */
exports.sendMusic = async function (openid, music, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"music",
 ...
 */
exports.sendNews = async function (openid, articles, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"news",
 ...
 */
exports.sendMpNews = async function (openid, mediaId, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  var url = this.prefix + 'message/custom/send?access_token=' + accessToken;
  var data = {
    'touser': openid,
 ...
 */
exports.sendMiniProgram = async function (openid, miniprogram, kfaccount) {
  const { accessToken } = await this.ensureAccessToken();
  var url = this.prefix + 'message/custom/send?access_token=' + accessToken;
  var data = {
    'touser': openid,
